...
- Заменить встроенные баннеры на неактивирующие auto-dismiss toast-уведомления справа сверху.
- Toast для hotkeys и неактивных сессий не должен забирать focus или попадать в поддерживаемый
  системный capture.
